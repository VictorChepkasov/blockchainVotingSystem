...
/*
    Скорее всего прийдётся делать переработку кода, то есть:
    - Избавиться от фабрики
    - Добавить счётчик в этот контракт
    - Этот контракт будет разворачиваться один раз и работать 
*/
